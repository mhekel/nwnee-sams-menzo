...
/*
  ...
  *
    ...
    SetLocalString(GetModule(), "XO_CAMPAIGN_DB", "sots_campaign_db");
...
string X0_DATABASE_DEFAULT = "sots_campaign_db_default";

string X0_DATABASE_XP1 = "sots_campaign_db_xp1";
